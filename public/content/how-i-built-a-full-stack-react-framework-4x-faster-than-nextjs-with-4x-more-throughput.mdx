...
rari isn't another Node.js framework with performance optimizations—it's a fundamental rethinking of how React applications should run. Built on a custom Rust runtime with V8 at its core, rari proves that web frameworks can be both developer-friendly and fast.
...
Throughout my career, I've seen the same pattern repeat: frameworks prioritize developer experience over performance, then spend years optimizing. I believe you can have both from day one.

Current React frameworks make architectural compromises that limit their performance ceiling. By building on Rust while maintaining JavaScript compatibility, I wanted to see if I could break through those limitations. rari is MIT licensed and represents the framework I wish I'd had for the past decade.
