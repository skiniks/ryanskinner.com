...
<template>
  <div class="flex justify-center items-center min-h-screen">
    <div v-if="entries.length > 0" :key="entries[0].path" class="max-w-3xl px-12 py-14 bg-gray-900 light:bg-gray-800/80 rounded-lg">
      ...
      <h1 class="mb-4 text-5xl font-bold text-white leading-tight">
